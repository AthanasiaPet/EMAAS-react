        ...
        <div>
            ...
            <section className="bg-white py-20 px-6">
                <div className="max-w-3xl mx-auto flex flex-col gap-8">
                    ...
                    {/* Paragraph 1 */}
                    <div className="bg-[#f8f6f1] border border-gray-200 border-l-4 border-l-[#c9a96e] p-8">
                    ...
                    {/* Founding */}
                    <div className="bg-white border border-gray-200 border-l-4 border-l-[#c9a96e] p-8">
                        <h3 className="font-serif text-xl font-semibold text-[#1b2a3b] mb-4">Founding of EMAAS</h3>
                        <p className="text-gray-500 text-base leading-relaxed">
                    ...
                    {/* Webster Partnership */}
                    <div className="bg-white border border-gray-200 border-l-4 border-l-[#c9a96e] p-8">
                        <h3 className="font-serif text-xl font-semibold text-[#1b2a3b] mb-4">EMAAS & Webster University Partnership</h3>
                        <p className="text-gray-500 text-base leading-relaxed">
