    ...
    return (
        <div>
            ...
            <section className="bg-[#8b4513] py-20 px-6 text-center">
                ...
                <h1 className="font-serif text-4xl font-bold text-white mb-5">Our History</h1>
            ...
            <section className="bg-white py-20 px-6">
                <div className="max-w-3xl mx-auto flex flex-col gap-8">
                    ...
                    {/* Quote block */}
                    <div className="bg-[#8b4513] p-8">
                        <p className="font-serif text-lg text-white leading-relaxed italic">
                    ...
                    {/* Paragraph 1 */}
                    <div className="bg-[#f8f6f1] border border-gray-200 border-l-4 border-l-[#f6ac3d] p-8">
                    ...
                    {/* Founding */}
                    <div className="bg-white border border-gray-200 border-l-4 border-l-[#f6ac3d] p-8">
                        <h3 className="font-serif text-xl font-semibold text-[#8b4513] mb-4">Founding of EMAAS</h3>
                        <p className="text-gray-500 text-base leading-relaxed">
                    ...
                    {/* Webster Partnership */}
                    <div className="bg-white border border-gray-200 border-l-4 border-l-[#f6ac3d] p-8">
                        <h3 className="font-serif text-xl font-semibold text-[#8b4513] mb-4">EMAAS & Webster University Partnership</h3>
                        <p className="text-gray-500 text-base leading-relaxed">
