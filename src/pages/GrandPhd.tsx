    ...
    return (
        <div>
            ...
            <section className="bg-[#8b4513] py-20 px-6 text-center">
                <p className="text-[11px] uppercase tracking-[0.14em] text-[#f6ac3d] mb-4">Research</p>
            ...
            <section className="bg-white py-20 px-6">
                <div className="max-w-3xl mx-auto text-center">
                    <p className="text-[11px] uppercase tracking-[0.14em] text-[#a0522d] mb-3">About the Degree</p>
                    <div className="w-10 h-0.5 bg-[#f6ac3d] mx-auto mb-8"></div>
            ...
            <section className="bg-[#f8f6f1] py-20 px-6">
                <div className="max-w-5xl mx-auto">
                    <p className="text-[11px] uppercase tracking-[0.14em] text-[#a0522d] text-center mb-3">Eligibility Requirements</p>
                        ...
                        {requirements.map((req, index) => (
                            <div key={index} className="bg-white border border-gray-200 border-l-4 border-l-[#f6ac3d] p-8 hover:shadow-md transition-shadow">
                                <div className="w-11 h-11 bg-[#8b4513] flex items-center justify-center mb-5">
                                    <FontAwesomeIcon icon={req.icon} className="text-[#f6ac3d] text-lg" />
                                </div>
                                <h3 className="font-serif text-lg font-semibold text-[#8b4513] mb-3">{req.title}</h3>
            ...
            <section className="bg-white py-20 px-6">
                <div className="max-w-3xl mx-auto">
                    <p className="text-[11px] uppercase tracking-[0.14em] text-[#a0522d] text-center mb-3">How to Apply</p>
                    <div className="w-10 h-0.5 bg-[#f6ac3d] mx-auto mb-10"></div>
                    <div className="bg-[#f8f6f1] border border-gray-200 border-l-4 border-l-[#f6ac3d] p-8 mb-8">
                        ...
                        <ul className="flex flex-col gap-3">
                            {[
                                ...
                                <li key={index} className="flex items-start gap-3">
                                    <div className="w-1.5 h-1.5 rounded-full bg-[#f6ac3d] mt-2 shrink-0"></div>
                    ...
                    <div className="text-center">
                        ...
                        className="inline-flex items-center gap-3 bg-[#8b4513] text-[#f6ac3d] text-[14px] tracking-wider px-8 py-4 hover:bg-[#73390f] transition-colors"
                        >
